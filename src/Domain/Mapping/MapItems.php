...
class MapItems implements \Countable
{
    ...
    {
        return array_filter($this->items, static fn (MapItem $mapItem) => $mapItem->isArray());
    }
    ...
    {
        return array_filter($this->items, static fn (MapItem $mapItem) => $mapItem->isArray() === false);
    }
